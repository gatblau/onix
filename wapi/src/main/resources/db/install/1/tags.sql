...
/*
  ...
  */
CREATE OR REPLACE FUNCTION ox_create_tag(
...
/*
  ...
  */
CREATE OR REPLACE FUNCTION ox_update_tag(
  root_item_key_param character varying,
...
$BODY$;
   ...
   */
  CREATE OR REPLACE FUNCTION ox_delete_tag(
    root_item_key_param character varying,
   ...
   */
  CREATE OR REPLACE FUNCTION ox_get_tree_content(
    root_item_key_param character varying,
  ...
  */
  CREATE OR REPLACE FUNCTION ox_get_tree_items(
    root_item_key_param character varying,
    label_param character varying
  )
  RETURNS TABLE(
  ...
  /*
    ox_get_tree_links(root_item_key_param, label_param): gets a list of all the links that are part
      of a tag tree for a specific parent item and a label.
   */
  CREATE OR REPLACE FUNCTION ox_get_tree_links(
    root_item_key_param character varying,
    label_param character varying
  )
  RETURNS TABLE(
