...
func NewKeyGenCmd() *KeyGenCmd {
	...
	c.cmd.Flags().StringVarP(&c.prefix, "prefix", "p", "id", "The prefix given to the generated key pair, defaults to 'id' which produces: id_rsa_key.pem (private key) and id_rsa_pub.pem (public key).\nIf specified, the naming is [name]_rsa_key.pem (private key) and [name]_rsa_pub.pem (public key)")
