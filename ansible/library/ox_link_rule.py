...
def deleteLinkRule(module):
    ...
    stream = open_url(link_rule_uri, method="DELETE", headers=headers)
...
def createOrUpdateLinkRule(module):
    ...
    link_type_key = data['linkTypeKey']
    start_item_type_key = data['startItemTypeKey']
    end_item_type_key = data['endItemTypeKey']
    ...
    # put the payload to the cmdb service
    stream = open_url(link_rule_uri, method="PUT", data=payloadStr, headers=headers)
