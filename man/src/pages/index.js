...
const features = [
  {
    ...
    imageUrl: 'img/single_source.png',
    description: (
      <>
  ...
  {
    title: <>report securely across your landscape</>,
    imageUrl: 'img/single_source.png',
    description: (
      <>
        Create flexible reports that aggregate and analyse your data.
      </>
    ),
  },
  {
        ...
        <div className="container">
          ...
          <div className={styles.buttons}>
            <Link
              ...
              to={useBaseUrl('docs/concept_users')}>
              Get Started
            </Link>
          </div>
        </div>
